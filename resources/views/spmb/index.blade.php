...
<html lang="id">
    ...
    <body class="spmb-page school-page bg-slate-100 text-slate-900">
        ...
        <x-site.navbar active="spmb" subtitle="Penerimaan Peserta Didik Baru" />
        ...
        <main>
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14 lg:px-8 lg:pb-16">
                <div class="spmb-cta-box" data-spmb-fade>
                    ...
                    <a href="https://wa.me/62318913900?text=Halo%20Admin%20SDN%20Kragan,%20saya%20ingin%20menghubungi%20sekolah." class="spmb-cta-link" target="_blank" rel="noopener noreferrer">Hubungi Sekolah</a>
                </div>
            </section>
        </main>
