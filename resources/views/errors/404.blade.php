...
<html lang="id">
    <head>
        ...
        <title>404 - Halaman Tidak Ditemukan | SDN Kragan</title>
    ...
    <body class="min-h-screen bg-slate-100 text-slate-900">
        <main class="flex min-h-screen items-center justify-center px-4">
            <div class="text-center">
                <div class="mb-8">
                    <p class="text-8xl font-bold text-[#c20f1a]">404</p>
                    <p class="mt-4 text-3xl font-semibold text-slate-900">Halaman Tidak Ditemukan</p>
                    <p class="mt-2 text-slate-600">Maaf, halaman yang Anda cari tidak dapat ditemukan.</p>
                </div>
