...
<html lang="id">
    <head>
        ...
        <title>Edit Prestasi | Dashboard Guru SDN Kragan</title>
            ...
            <div class="space-y-6">
                ...
                <header class="rounded-3xl bg-white p-6 shadow-lg">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm uppercase tracking-[0.25em] text-orange-600 font-semibold">Edit Prestasi</p>
                            <h1 class="mt-2 text-3xl font-semibold text-slate-900">Edit Data Prestasi</h1>
                ...
                <div class="rounded-3xl bg-white p-8 shadow-lg">
                    <form method="POST" action="{{ route('teacher.achievements.update', $achievement) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Kepemimpinan" {{ $achievement->category == 'Kepemimpinan' ? 'selected' : '' }}>Kepemimpinan</option>
                        ...
                        <div class="flex gap-4 pt-6">
                            <button
                                type="submit"
                                class="flex-1 rounded-xl bg-orange-600 px-6 py-3 font-semibold text-white hover:bg-orange-700 transition"
                            >
                                ✓ Perbarui Prestasi
                            </button>
                            <a
