                ...
                <div class="header-left flex min-w-0 items-center gap-2 lg:gap-3">
                    <div class="header-brand">
                        ...
                        <div class="header-brand-copy">
                            ...
                            <p class="brand-subtitle mt-1 text-xs text-slate-500">Data Guru & Karyawan</p>
                        </div>
                    </div>
        ...
        <main>
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14 lg:px-8 lg:pb-16">
                <div class="guru-cta-box" data-guru-fade>
                    ...
                    <a href="https://wa.me/62318913900?text=Halo%20Admin%20SDN%20Kragan,%20saya%20ingin%20menghubungi%20sekolah." class="guru-cta-link" target="_blank" rel="noopener noreferrer">Hubungi Sekolah</a>
                </div>
            </section>
        </main>
