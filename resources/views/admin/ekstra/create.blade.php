...
<html lang="id">
    ...
    <body class="min-h-screen bg-slate-100 text-slate-900">
        <main class="mx-auto max-w-3xl p-6">
            ...
            <form action="{{ route('admin.ekstra.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 rounded-3xl bg-white p-6 shadow-lg">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <div id="photoPreviewWrap" class="mt-3 hidden">
                        ...
                        <img id="photoPreview" alt="Preview foto ekstra" class="mt-2 h-48 w-48 rounded-2xl object-cover shadow-sm" />
                    </div>
