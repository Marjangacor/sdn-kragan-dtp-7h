...
<html lang="id">
    <head>
        ...
        <title>Kelola Ekstrakurikuler | Admin SDN Kragan</title>
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 class="mt-2 text-3xl font-semibold text-slate-900">Kelola Ekstrakurikuler</h1>
                        <p class="mt-2 text-sm text-slate-600">Tambah, edit, atau hapus kegiatan ekstrakurikuler sekolah.</p>
                    </div>
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="{{ route('admin.ekstra.create') }}" class="inline-flex items-center rounded-xl bg-[#c20f1a] px-4 py-3 text-sm font-semibold text-white transition hover:opacity-95">Tambah Kegiatan</a>
                    </div>
                </div>
            </header>
            ...
            <div class="overflow-hidden rounded-3xl bg-white shadow-lg">
                <table class="w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-700">
                        <tr>
                            <th class="px-6 py-4 font-medium">Nama Kegiatan</th>
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-slate-900">
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <form action="{{ route('admin.ekstra.destroy', $activity) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-slate-500">Belum ada kegiatan ekstrakurikuler.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
