...
<html lang="id">
    <head>
        ...
        <title>Kelola Guru | Admin SDN Kragan</title>
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <h1 class="mt-2 text-3xl font-semibold text-slate-900">Kelola Guru & Karyawan</h1>
                        <p class="mt-2 text-sm text-slate-600">Tambah, edit, atau hapus data guru dan karyawan sekolah.</p>
                    </div>
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="{{ route('admin.guru.create') }}" class="inline-flex items-center rounded-xl bg-[#c20f1a] px-4 py-3 text-sm font-semibold text-white transition hover:opacity-95">Tambah Data</a>
                    </div>
                </div>
            </header>
                ...
                <table class="w-full divide-y divide-slate-200 text-left text-sm">
                    <thead class="bg-slate-50 text-slate-700">
                        <tr>
                            ...
                            <th class="px-6 py-4 font-medium">Mata Pelajaran / Bidang</th>
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-slate-900">
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <form action="{{ route('admin.guru.destroy', $teacher) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-slate-500">Belum ada data guru atau karyawan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
