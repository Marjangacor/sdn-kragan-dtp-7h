...
<html lang="id">
    ...
    <body class="min-h-screen bg-slate-100 text-slate-900">
        <main class="mx-auto max-w-7xl p-6 grid gap-6 lg:grid-cols-[280px_1fr]">
                ...
                <header class="rounded-3xl bg-white p-6 shadow-lg">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-slate-600">Pantau pengguna, feedback, dan pendaftar SPMB.</p>
                        </div>
            ...
            <!-- SPMB Statistics -->
            <section class="mb-8">
                <h2 class="mb-4 text-2xl font-semibold text-slate-900">Statistik Pendaftar SPMB</h2>
