...
<html lang="id">
    ...
    <body class="school-page bg-slate-100 text-slate-900">
        <header class="site-header sticky top-0 z-40 border-b border-slate-200 bg-white">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
                <div class="header-left flex items-center gap-12">
                    ...
                    <nav class="nav-list hidden items-center gap-2 lg:flex">
                        ...
                        <a href="#visi-misi" class="nav-chip">Guru & Karyawan</a>
            ...
            <div id="mobileMenu" class="hidden border-t border-slate-200 bg-white px-4 py-3 lg:hidden">
                <div class="grid gap-2 text-sm font-medium text-slate-700">
                    ...
                    <a href="#visi-misi" class="rounded-lg px-3 py-2 hover:bg-slate-100">Guru & Karyawan</a>
        ...
        <main class="overflow-hidden">
            <section id="beranda" class="hero-wrap relative text-white">
                ...
                <div class="hero-grid relative mx-auto grid max-w-7xl gap-10 px-6 py-14 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-16">
                    <div class="hero-copy space-y-7">
                        ...
                        <div id="heroFeatureBox" class="hero-feature-box reveal" style="--reveal-delay: 220ms">
                            <div id="heroCtaGroup" class="hero-cta-group flex flex-wrap gap-4">
                            ...
                            <div id="heroStats" class="hero-stats-grid mt-5 grid max-w-3xl grid-cols-3 gap-4">
                                <article class="stat-card stat-card-lg">
                                ...
                                <article class="stat-card stat-card-lg">
                                    ...
                                    <p class="stat-label">Tenaga Didik</p>
                                </article>
                                <article class="stat-card stat-card-lg">
                    ...
                    <div class="reveal" style="--reveal-delay: 260ms">
                        <div id="heroCard" class="hero-image-card aspect-[16/10]">
            ...
            <section id="tentang" class="bg-slate-100 py-16 lg:py-20">
                <div class="mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:px-8">
                    <div class="overflow-hidden rounded-3xl bg-white shadow-xl shadow-slate-900/10 reveal">
                    ...
                    <article class="rounded-3xl bg-white p-8 shadow-xl shadow-slate-900/8 reveal" style="--reveal-delay: 140ms">
            ...
            <section id="visi-misi" class="bg-stone-200/70 py-16 lg:py-20">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div class="mt-10 grid gap-6 lg:grid-cols-2">
                        <article class="rounded-3xl bg-white p-8 shadow-xl shadow-slate-900/8 reveal" style="--reveal-delay: 80ms">
                        ...
                        <article class="rounded-3xl bg-white p-8 shadow-xl shadow-slate-900/8 reveal" style="--reveal-delay: 180ms">
            ...
            <section id="profil" class="bg-slate-100 py-16 lg:py-20">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl text-center reveal">
                    ...
                    <div class="mt-10 grid gap-8 lg:grid-cols-[1fr_1fr]">
                        <article class="space-y-5 rounded-3xl bg-white p-8 shadow-xl shadow-slate-900/8 reveal" style="--reveal-delay: 80ms">
                        ...
                        <div class="grid grid-cols-2 gap-4 reveal" style="--reveal-delay: 180ms">
                            <div class="overflow-hidden rounded-2xl bg-white shadow-md"><img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=700&q=80" alt="Aktivitas belajar 1" class="h-full w-full object-cover" /></div>
                            <div class="overflow-hidden rounded-2xl bg-white shadow-md"><img src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?auto=format&fit=crop&w=700&q=80" alt="Aktivitas belajar 2" class="h-full w-full object-cover" /></div>
                            <div class="overflow-hidden rounded-2xl bg-white shadow-md"><img src="https://images.unsplash.com/photo-1564429097439-e4003821ea40?auto=format&fit=crop&w=700&q=80" alt="Aktivitas belajar 3" class="h-full w-full object-cover" /></div>
                            <div class="overflow-hidden rounded-2xl bg-white shadow-md"><img src="https://images.unsplash.com/photo-1588072432836-e10032774350?auto=format&fit=crop&w=700&q=80" alt="Aktivitas belajar 4" class="h-full w-full object-cover" /></div>
                        </div>
                    </div>
                </div>
            </section>

            <section id="filosofi" class="bg-stone-200/70 py-16 lg:py-20">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl text-center reveal">
                    ...
                    <div class="mt-10 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div class="flex items-center justify-center reveal" style="--reveal-delay: 80ms">
                            <div class="rounded-3xl bg-white p-7 shadow-2xl shadow-slate-900/12">
                                <div class="logo-box">
                        ...
                        <div class="space-y-4 reveal" style="--reveal-delay: 180ms">
                            <article class="feature-card border-l-blue-600">
        ...
        <aside id="accessibilityPanel" class="acc-panel" aria-hidden="true">
            ...
            <div class="acc-list">
                <button class="acc-item" type="button" data-acc-action="text-increase"><span class="acc-item-icon">A+</span><span>Perbesar Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="text-decrease"><span class="acc-item-icon">A-</span><span>Perkecil Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="letter-increase"><span class="acc-item-icon">Aa</span><span>Tambah Jarak Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="letter-decrease"><span class="acc-item-icon">Aa</span><span>Kurangi Jarak Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="line-increase"><span class="acc-item-icon">| |</span><span>Tambah Tinggi Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="line-decrease"><span class="acc-item-icon">||</span><span>Kurangi Tinggi Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="invert"><span class="acc-item-icon">◐</span><span>Balik Warna</span></button>
                <button class="acc-item" type="button" data-acc-action="grayscale"><span class="acc-item-icon">BW</span><span>Warna Abu-Abu</span></button>
                <button class="acc-item" type="button" data-acc-action="underline"><span class="acc-item-icon">U</span><span>Garis Bawahi Teks</span></button>
                <button class="acc-item" type="button" data-acc-action="big-cursor"><span class="acc-item-icon">↖</span><span>Perbesar Kursor</span></button>
                <button class="acc-item" type="button" data-acc-action="reading-guide"><span class="acc-item-icon">≡</span><span>Alat Bantu Baca</span></button>
                <button class="acc-item" type="button" data-acc-action="reduce-motion"><span class="acc-item-icon">Ø</span><span>Matikan Animasi</span></button>
            </div>
        </aside>
