    ...
    <body class="min-h-screen bg-slate-100 text-slate-900">
        <main class="flex min-h-screen items-center justify-center px-4 py-10">
            <section class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_24px_60px_rgba(15,23,42,0.12)]">
                ...
                <div class="mt-6 space-y-3 text-center text-sm text-slate-500">
                    <p>Belum punya akun? <a href="{{ route('register') }}" class="font-semibold text-[#8f0f16] hover:underline">Daftar sekarang</a></p>
                    <p><a href="{{ route('home') }}" class="font-semibold text-[#8f0f16] hover:underline">Kembali ke beranda</a></p>
                </div>
            </section>
        </main>
    </body>
