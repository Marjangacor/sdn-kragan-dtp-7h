        ...
        <div class="space-y-5 reveal js-card">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-blue-100/80">{{ $subtitle }}</p>
                </div>
            </div>
            <p class="max-w-md text-sm leading-7 text-blue-100/80">{{ $description }}</p>
        </div>
        <div class="grid gap-6 sm:grid-cols-2">
            <div class="reveal js-card" style="--reveal-delay: 80ms">
                <h3 class="text-sm font-semibold text-white">Tautan Cepat</h3>
                <ul class="space-y-3 list-disc pl-5 text-slate-600 marker:text-white-600">
