...
<html lang="id">
    ...
    <body class="kritik-page school-page bg-slate-100 text-slate-900">
        ...
        <header class="kritik-header sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 lg:px-8">
                ...
                <a href="{{ url('/') }}" class="kritik-back-link">Kembali ke Beranda</a>
            </div>
        </header>
        ...
        <main>
            ...
            <section class="mx-auto max-w-7xl px-6 pb-14 lg:px-8 lg:pb-16">
                <div class="kritik-cta-box" data-kritik-fade>
                    <div>
                        <p class="kritik-info-kicker text-blue-100">Komitmen Sekolah</p>
